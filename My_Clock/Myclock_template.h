...
#ifndef _MYCLOCK_TEMPLATE_H_
#define _MYCLOCK_TEMPLATE_H_

//---------- MAX 7219-----------------
#define CLK  16  //GPIO16    //D0
#define Din  00  //GPIO0    //D3
#define LD   02  //GPIO2    //D4
#define GLD  15  //GPIO15   //D8

//#define SCL 05  //D1    // MicroOLED Definition //
//#define SDA 04  //D2
#define PIN_RESET   16  //D0    Connect RST to pin 9 (SPI & I2C)
//#define PIN_CS    05  //D1   Connect CS to pin 10 (SPI only)
//#define PIN_DC    04  //D2   Connect DC to pin 8 (SPI only)
#define DC_JUMPER   00  //D3   DC jumper setting(I2C only)
