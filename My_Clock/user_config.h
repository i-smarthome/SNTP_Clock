...
// -- Project -------------------------------------
#define PROJECT                "iClock"          // PROJECT is used as the default topic delimiter and OTA file name
                                                 //   As an IDE restriction it needs to be the same as the main .ino file

#define CFG_HOLDER             0x20171104        // [Reset 1] Change this value to load following default configuration parameters
...
#define STA_SSID1              "Thanwa Home"      // [Ssid1] Wifi SSID
#define STA_PASS1              "4720284589_Thanwa"  // [Password1] Wifi password
#define STA_SSID2              "sunate"      // [Ssid2] Optional alternate AP Wifi SSID
#define STA_PASS2              "4720284589"  // [Password2] Optional alternate AP Wifi password
#define WIFI_CONFIG_TOOL       WIFI_WPSCONFIG    // [WifiConfig] Default tool if wifi fails to connect
                                                 //   (WIFI_RESTART, WIFI_SMARTCONFIG, WIFI_MANAGER, WIFI_WPSCONFIG, WIFI_RETRY, WIFI_WAIT)

// -- Syslog --------------------------------------
#define SYS_LOG_HOST           "ismarthome"          // [LogHost] (Linux) syslog host
...
// -- Ota -----------------------------------------
#define OTA_URL                "http://ismarthome:80/api/arduino/" PROJECT ".ino.bin"  // [OtaUrl]
...
#ifdef USE_MQTT_TLS
  #define MQTT_HOST            "m11.cloudmqtt.com"  // [MqttHost]
  #define MQTT_FINGERPRINT     "A5 02 FF 13 99 9F 8B 39 8E F1 83 4F 11 23 65 0B 32 36 FC 07"  // [MqttFingerprint]
  #define MQTT_PORT            36215               // [MqttPort] MQTT TLS port
  #define MQTT_USER            "cloudmqttuser"      // [MqttUser] Mandatory user
  #define MQTT_PASS            "cloudmqttpassword"  // [MqttPassword] Mandatory password
#else
  #define MQTT_HOST            "i-smarthome"          // [MqttHost]
  #define MQTT_PORT            1883              // [MqttPort] MQTT port (10123 on CloudMQTT)
  #define MQTT_USER            "iClock"      //"DVES_USER"       // [MqttUser] Optional user
  #define MQTT_PASS            "iClock"     //"DVES_PASS"       // [MqttPassword] Optional password
#endif
...
#define MQTT_GRPTOPIC          "iclocks"         // [GroupTopic] MQTT Group topic
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+66k code, +8k mem) - Disable by //
  ...
  #define WEB_PASSWORD         "4720284589"      // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
  #define FRIENDLY_NAME        "iclock"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#define TIME_DST               North, Last, Sun, Mar, 2, +(120 *7)  // Northern Hemisphere, Last sunday in march at 02:00 +120 minutes

// -- Time - Start Standard Time and timezone offset from UTC in minutes
#define TIME_STD               North, Last, Sun, Oct, 3, +(60 *7)   // Northern Hemisphere, Last sunday in october 02:00 +60 minutes

// -- Application ---------------------------------
#define APP_TIMEZONE           7                 // [Timezone] +7 hour (Bangkok Thailand) (-12 .. 12 = hours from UTC, 99 = use TIME_DST/TIME_STD)
